...
import com.gitee.whzzone.common.enums.ProvideType;
...
public class DataScopeServiceImpl extends ServiceImpl<DataScopeMapper, DataScope> implements DataScopeService {
    ...
    public List<Long> execRule(String name) {
        try {
            ...
            if (dataScopeEntity.getProvideType().equals(ProvideType.VALUE.getCode())){

            }else if (dataScopeEntity.getProvideType().equals(ProvideType.METHOD.getCode())){
